...
/* creates random vec of size n */
double* getRandVec(int n);
/* preforming multiplication of matrix A and given vector, the result will be insert to *result */
void getAVmult(const double *eigenVec, subSpmat *sp, double* result);
/* preforming multiplication of the ranks matrix and given vector, the result will be insert to *result */
void getRanksMult(double *eigenVec, subSpmat *sp, double *result);
/* preforming the f and shift value of A multiplication with given vector, the result will be insert to *result */
void getShiftandFMult(double *eigenVec, subSpmat *sp,double *f, double *result);
/* computing the multiplication of f vector with division vector */
void getFdivMult(double *division, double *f, double *cVec, int n);
/* sums vectors into *result */
void sumAll(double *aVec, double *bVec, double *cVec, double *result, int n);
/* normalize vector of len n */
void normalize(double *vec, int n);
/* preforming 2 vectors multiplication */
double vecDot(double *aVec, double *bVec,int n);
/* updating the eigen vector according to VBk and counts how many small diferences there are*/
